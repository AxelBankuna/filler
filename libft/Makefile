...
#    Updated: 2018/04/27 17:27:05 by abukasa          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memchr.c ft_memmove.c ft_strdup.c ft_memcmp.c ft_memset.c ft_strlen.c \
      ft_bzero.c ft_memcpy.c ft_strcpy.c ft_strncpy.c ft_memccpy.c ft_strcat.c \
...
OBJECTS = ft_memchr.o ft_memmove.o ft_strdup.o ft_memcmp.o ft_memset.o ft_strlen.o \
      ft_bzero.o ft_memcpy.o ft_strcpy.o ft_strncpy.o ft_memccpy.o ft_strcat.o \
	  ...
	  ft_strjoin.o ft_strtrim.o ft_strsplit.o ft_putchar.o ft_putstr.o ft_putendl.o\
